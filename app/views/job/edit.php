			...
			<div class="panel-body">
				<form class="form-horizontal" method="POST" action="<?php echo url();?>/job">
					...
					<div class="form-group required">
						...
						<div class="col-sm-6">
							<input type="text" name="max_salary" value="<?php echo $data->max_salary;?>" class="form-control" required/>
						</div>
					</div>
					<div class="form-group required">
						<label class="col-sm-2 control-label">Min Salary</label>
						<div class="col-sm-6">
							<input type="text" name="min_salary" value="<?php echo $data->min_salary;?>" class="form-control" required/>
						</div>
					</div>
					<div class="pull-right">
